...
#             track.make_mask([],man_list = mask ,verbos=v_tmask)
    ...
    #             print(v_ANOM)
            ...
            track.flag_surf_type_20_ku_LEGOS_GPOD_attr = track.flag_surf_type_20_ku_CLS_attr
            track.flag_surf_type_20_ku_LEGOS_GPOD_attr['comment'] = (
               'A 4-state surface type mask for Cryosat2 data from the LEGOS GPOD along track data.'
               'Flag file converted from the three original supplied flag files: '
               'flag_floes_meas_valid_20hz,flag_leads_meas_valid_20hz,flag_open_ocean_meas_valid_20h')
